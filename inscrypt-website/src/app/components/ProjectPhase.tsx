...
const ProjectPhase: React.FC<ProjectPhaseProps> = ({ phase, duration, deliverables, requirements }) => {
    ...
    <Card className="mb-8 overflow-hidden bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl">
      ...
      >
        <CardTitle className="text-2xl font-bold text-gray-800 dark:text-gray-100">
          Phase {phase} <span className="text-sm font-normal ml-2 text-gray-500 dark:text-gray-400">({duration})</span>
        </CardTitle>
